import{S as e}from"./index-Dzjvkj7X.js";const o="lightFragmentDeclaration",n=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=n);const i="lightUboDeclaration",d=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=l);const a="shadowsFragmentFunctions",f=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=f);const r="reflectionFunction",h=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=h);const s="lightFragment",c=`#ifdef LIGHT{X}
