import{S as e}from"./index-Dzjvkj7X.js";import"./oitFragment-DjO4BkcT.js";import"./harmonicsFunctions-DMb8TdMT.js";import"./mainUVVaryingDeclaration-CbfOwoC_.js";import"./lightFragment-Ci-Ch8te.js";import"./hdrFilteringFunctions-BfpvgYkU.js";import"./pbrBRDFFunctions-BCPCiXCT.js";import"./clusteredLightingFunctions-C7LxCcfO.js";import"./meshUboDeclaration-u0U09y7_.js";const n="pbrFragmentDeclaration",G=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=G);const a="pbrFragmentExtraDeclaration",V=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=V);const o="samplerFragmentAlternateDeclaration",H=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=H);const r="pbrFragmentSamplersDeclaration",x=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=x);const t="subSurfaceScatteringFunctions",W=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=W);const f="pbrHelperFunctions",Y=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=Y);const c="pbrDirectLightingSetupFunctions",X=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=X);const l="pbrDirectLightingFalloffFunctions",k=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=k);const d="pbrDirectLightingFunctions",w=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=w);const s="pbrIBLFunctions",z=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=z);const E="pbrBlockAlbedoOpacity",K=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=K);const R="pbrBlockReflectivity",$=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=$);const u="pbrBlockAmbientOcclusion",q=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=q);const C="pbrBlockAlphaFresnel",Z=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Z);const S="pbrBlockAnisotropic",j=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=j);const A="pbrBlockReflection",J=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=J);const m="pbrBlockSheen",Q=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=Q);const I="pbrBlockClearcoat",ee=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=ee);const v="pbrBlockIridescence",ie=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=ie);const O="pbrBlockSubSurface",ne=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=ne);const N="pbrBlockReflectance0",ae=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=ae);const T="pbrClusteredLightingFunctions",oe=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=oe);const L="pbrBlockNormalGeometric",re=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=re);const p="pbrBlockNormalFinal",te=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=te);const g="pbrBlockLightmapInit",fe=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=fe);const D="pbrBlockGeometryInfo",ce=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=ce);const _="pbrBlockReflectance",le=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=le);const h="pbrBlockDirectLighting",de=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=de);const M="pbrBlockFinalLitComponents",se=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=se);const F="pbrBlockFinalUnlitComponents",Ee=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Ee);const P="pbrBlockFinalColorComposition",Re=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=Re);const U="pbrBlockImageProcessing",ue=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=ue);const b="pbrBlockPrePass",Ce=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Ce);const B="pbrDebug",Se=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=Se);const i="pbrPixelShader",y=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=y);const ge={name:i,shader:y};export{ge as pbrPixelShader};
