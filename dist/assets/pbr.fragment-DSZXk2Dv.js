import{S as e}from"./index-Dzjvkj7X.js";import"./oitFragment-DvSdyJyl.js";import"./harmonicsFunctions-AOPTpwCl.js";import"./mainUVVaryingDeclaration-B3YeFtVY.js";import"./lightFragment-BBKkfwbJ.js";import"./bumpFragment-CsRqW6Ap.js";import"./imageProcessingFunctions-CYK-5g51.js";import"./clipPlaneFragment-GoF-USLz.js";import"./logDepthDeclaration-C4SO4Xqp.js";import"./fogFragment-BKB60XOd.js";import"./helperFunctions-DasE0l1Z.js";import"./hdrFilteringFunctions-Ct6AFBZc.js";import"./pbrBRDFFunctions-Bq5URSEz.js";import"./clusteredLightingFunctions-CAn2s6xP.js";import"./logDepthFragment-BWbfPAr3.js";import"./sceneUboDeclaration-BWJx_-An.js";import"./meshUboDeclaration-CRQzgs7-.js";const r="pbrFragmentExtraDeclaration",B=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=B);const a="samplerFragmentAlternateDeclaration",G=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=G);const n="pbrFragmentSamplersDeclaration",y=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
}`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=W);const l="pbrBlockReflectance0",Y=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=Y);const d="pbrDirectLightingFunctions",w=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=w);const s="pbrIBLFunctions",k=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=k);const E="pbrBlockAlbedoOpacity",X=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=X);const u="pbrBlockReflectivity",z=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=z);const m="pbrBlockAmbientOcclusion",K=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=K);const S="pbrBlockAlphaFresnel",$=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=$);const R="pbrBlockAnisotropic",q=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=q);const v="pbrBlockReflection",Z=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=Z);const C="pbrBlockSheen",j=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=j);const p="pbrBlockClearcoat",J=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=J);const A="pbrBlockIridescence",Q=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=Q);const I="pbrBlockSubSurface",ee=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=ee);const O="pbrBlockNormalGeometric",ie=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=ie);const N="pbrBlockNormalFinal",re=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=re);const L="pbrBlockLightmapInit",ae=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=ae);const T="pbrBlockGeometryInfo",ne=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=ne);const g="pbrBlockReflectance",fe=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=fe);const h="pbrBlockDirectLighting",te=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=te);const D="pbrBlockFinalLitComponents",oe=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=oe);const _="pbrBlockFinalUnlitComponents",ce=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=ce);const M="pbrBlockFinalColorComposition",le=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=le);const F="pbrBlockImageProcessing",de=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=de);const P="pbrBlockPrePass",se=`#if SCENE_MRT_COUNT>0
...
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=Ee);const i="pbrPixelShader",b=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=b);const Me={name:i,shader:b};export{Me as pbrPixelShaderWGSL};
